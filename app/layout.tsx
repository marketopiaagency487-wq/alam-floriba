...
export const metadata: Metadata = {
  title: "علم الروم الساحل الشمالي | الأسعار تبدأ من 15 مليون — التفاصيل والتسجيل",
  description:
    "مشروع علم الروم Alam Al Roum بالساحل الشمالي — مدينة ساحلية متكاملة على 7.2 كم واجهة بحرية بشراكة الديار القطرية وهيئة المجتمعات العمرانية. أسعار استرشادية تبدأ من 15 مليون جنيه. منصة معلومات واستفسارات مستقلة — سجّل بياناتك ليتواصل معك فريق مبيعات معتمد.",
  keywords:
  ...
  openGraph: {
    title: "علم الروم | وجهة ساحلية جديدة على البحر المتوسط — الأسعار من 15 مليون",
    description:
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "الأسعار الاسترشادية المتداولة تبدأ من نحو 15 مليون جنيه، ويؤكد فريق المبيعات الأسعار الحالية وأنظمة السداد والتوافر وفق الطرح المتاح وقت الاستفسار.",
      },
    },
    {
      "@type": "Question",
...
const projectJsonLd = {
  ...
  description:
    "مدينة ساحلية متكاملة على 4,902 فدان بواجهة متوسطية 7.2 كم، بشراكة الديار القطرية وهيئة المجتمعات العمرانية الجديدة. أسعار استرشادية تبدأ من 15 مليون جنيه.",
  address: {
    "@type": "PostalAddress",
    addressRegion: "مطروح",
    addressCountry: "EG",
